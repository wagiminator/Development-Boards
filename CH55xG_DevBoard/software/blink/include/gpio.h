...
// ===================================================================================
#define portInput(PORT, PIN)    (P##PORT##_DIR_PU &= ~(1<<PIN), P##PORT##_MOD_OC &= ~(1<<PIN))
#define portInputPU(PORT, PIN)  (P##PORT##_MOD_OC |=  (1<<PIN), P##PORT##_DIR_PU |=  (1<<PIN))
#define portOutput(PORT, PIN)   (P##PORT##_MOD_OC &= ~(1<<PIN), P##PORT##_DIR_PU |=  (1<<PIN))
#define portOutputOD(PORT, PIN) (P##PORT##_MOD_OC |=  (1<<PIN), P##PORT##_DIR_PU &= ~(1<<PIN))

#define portLow(PORT, PIN)      P##PORT##_##PIN = 0
#define portHigh(PORT, PIN)     P##PORT##_##PIN = 1
#define portToggle(PORT, PIN)   P##PORT##_##PIN = !P##PORT##_##PIN
#define portRead(PORT, PIN)     (P##PORT##_##PIN)
