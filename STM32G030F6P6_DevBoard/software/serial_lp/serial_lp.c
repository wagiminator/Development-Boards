...
// Description:
// ------------
// Echoes data sent via low-power UART.
//
...
#include "lpuart.h"               // LPUART1 functions
...
int main (void) {
  // Setup
  LPUART_init();                  // init UART (TX: PA2, RX: PA3, BAUD: 115200, 8N1)
  
  // Loop
  while(1) {
    LPUART_write(LPUART_read()); // echo any received character
  }
}
