...
#elif F_CPU == 24000000
  #define NEO_DLY1  " c.li a1, 1 \n3: \n c.addi a1, -1 \n c.bnez a1, 3b \n"
  #define NEO_DLY2  " c.li a1, 2 \n4: \n c.addi a1, -1 \n c.bnez a1, 4b \n"
  #define NEO_DLY3  " c.li a1, 2 \n5: \n c.addi a1, -1 \n c.bnez a1, 5b \n"
#elif F_CPU == 16000000
  #define NEO_DLY1  " c.nop \n"
  #define NEO_DLY2  " c.li a1, 1 \n4: \n c.addi a1, -1 \n c.bnez a1, 4b \n"
  #define NEO_DLY3  " c.li a1, 1 \n5: \n c.addi a1, -1 \n c.bnez a1, 5b \n"
#elif F_CPU == 12000000
  #define NEO_DLY1
  #define NEO_DLY2  " c.nop \n c.nop \n c.nop \n"
  #define NEO_DLY3  " c.nop \n c.nop \n"
#else
...
#define NEO_GPIO_BASE \
  ((PIN_NEO>=PA0)&&(PIN_NEO<=PA15) ? ( GPIOA_BASE ) : \
  ((PIN_NEO>=PB0)&&(PIN_NEO<=PB15) ? ( GPIOB_BASE ) : \
  ((PIN_NEO>=PC0)&&(PIN_NEO<=PC15) ? ( GPIOC_BASE ) : \
(0))))
#define NEO_GPIO_BSHR   0x10
#define NEO_GPIO_BCR    0x14
#define NEO_PIN_BM      (1<<((PIN_NEO)&15))
